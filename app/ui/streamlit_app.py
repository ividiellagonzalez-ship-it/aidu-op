...
if tab_cartera:
    ...
    if not proyectos:
        ...
        proxima_accion = {
            "EN_CARTERA": ("🔬 Estudiar próximo", "EN_ESTUDIO"),
            "EN_ESTUDIO": ("📋 Pasar a Preparación", "EN_ESTUDIO"),
            "EN_ESTUDIO": ("🚀 Marcar Listo para Ofertar", "EN_OFERTA"),
            "EN_OFERTA": ("📤 Marcar como Ofertada", "LISTO_SUBIR"),
